...
-- ill leave this for here onyl right now cuz im too lazy to make if statements
...
local function get_lsp_status()
  local clients = vim.lsp.get_clients({ bufnr = 0 }) -- Replace deprecated function
  if #clients > 0 then
...
function StatusLine()
  ...
  local branch_data = get_git_branch()
