...
like i completly stole it and added like one autocmd with the help of ai because im lazy
--]]
...
local function create_intro_message()
  ...
  local lines = {
    ...
    { text = string.format('x * fov'), hl = 'NonText' },
    { text = string.format('───────'), hl = 'NonText' },
    { text = string.format('   z'), hl = 'NonText' },
